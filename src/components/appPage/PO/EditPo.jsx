...
function EditPo() {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(`${API_URL}/purchase-order/${id}`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let response = await axios.put(
        `${API_URL}/purchase-order/edit-purchase-order/${id}`,
        data , {
          headers: {
            Authorization: `Bearer ${token}` 
          }
  ...
  const handleBack = () => {
    navigate("/dashboard/actions-purchase-order");
  };
          ...
          <div className="row d-flex justify-content-center align-items-center h-100">
            <div>
              <div className="editHead">
                <h1 className="text-white mb-4">Edit Purchase Order</h1>
